...
<form class="layui-form" action="" id="form">
    <table width="95%" style="margin: 0 auto">
        <tr>
            ...
            <td colspan="3"><input type="text" name="role_name" id="role_name" value="${p.roleName}" lay-verify="required|field_len50" autocomplete="off" placeholder="角色名称" class="layui-input"></td>
        </tr>
        <tr>
            <td align="right"><label class="layui-form-label">角色等级：</label></td>
            <td colspan="3"><input type="text" name="role_level" id="role_level" value="${p.roleLevel}" lay-verify="field_len50|intNumber" autocomplete="off" placeholder="您只能创建等级：${role.roleLevel} 以上的角色" class="layui-input"></td>
        </tr>
        <tr>
