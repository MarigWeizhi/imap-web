...
<form class="layui-form" action="" id="form">
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" name="role_name" id="role_name" value="${p.role_name}" lay-verify="required|field_len50" autocomplete="off" placeholder="角色名称" class="layui-input">
            </div>
        </div>
    </div>
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline" style="width: 100px;">
                <input type="checkbox" <c:if test="${p.online=='1'}"> checked="checked" </c:if> name="online" lay-skin="switch" lay-filter="switchTest" lay-text="允许|禁止">
            </div>
            <label class="layui-form-label" style="width: 200px;">历史数据：</label>
            <div class="layui-input-inline" style="width: 100px;">
                <input type="checkbox" <c:if test="${p.history=='1'}"> checked="checked" </c:if>  name="history" lay-skin="switch" lay-filter="switchTest" lay-text="允许|禁止">
            </div>
        </div>
    </div>
    <%--        用户设置--%>
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline" style="width: 100px;">
                <input type="checkbox" <c:if test="${p.user=='1'}"> checked="checked" </c:if>  name="user" lay-skin="switch" lay-filter="switchTest" lay-text="允许|禁止">
            </div>
            <label class="layui-form-label" style="width: 200px;">角色管理：</label>
            <div class="layui-input-inline" style="width: 100px;">
                <input type="checkbox" <c:if test="${p.role=='1'}"> checked="checked" </c:if>  name="role" lay-skin="switch" lay-filter="switchTest" lay-text="允许|禁止">
            </div>
        </div>
    </div>
    <%--        站点设置--%>
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline" style="width: 100px;">
                <input type="checkbox" <c:if test="${p.site=='1'}"> checked="checked" </c:if>  name="site" lay-skin="switch" lay-filter="switchTest" lay-text="允许|禁止">
            </div>
            <label class="layui-form-label" style="width: 200px;">告警管理：</label>
            <div class="layui-input-inline" style="width: 100px;">
                <input type="checkbox" <c:if test="${p.alarm=='1'}"> checked="checked" </c:if>  name="alarm" lay-skin="switch" lay-filter="switchTest" lay-text="允许|禁止">
            </div>
        </div>
    </div>
    <%--    提交--%>
    <div class="layui-form-item" >
        <div class="layui-inline" style="width: 100%; text-align: center; padding-top: 10px;" >
            <input type="hidden" name="role_id" id="role_id" value="${p.role_id}" />
