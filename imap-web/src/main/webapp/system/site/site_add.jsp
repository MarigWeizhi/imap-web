...
<form class="layui-form" action="" id="form">
    <table width="95%" style="margin: 0 auto">
        <tr>
            ...
            <td align="right"><label class="layui-form-label">监控url：</label></td>
            <td colspan="3"><input type="text" name="url" id="url" lay-verify="field_len120" autocomplete="off" placeholder="站点监控url" class="layui-input"></td>
        </tr>
        <tr>
            <td align="right"><label class="layui-form-label">站点经度：</label></td>
            <td colspan="3"><input type="text" name="lat" id="lat" lay-verify="longitude" autocomplete="off" placeholder="站点经度" class="layui-input"></td>
            <td align="right"><label class="layui-form-label">站点纬度：</label></td>
            <td colspan="3"><input type="text" name="lon" id="lon" lay-verify="latitude" autocomplete="off" placeholder="站点纬度" class="layui-input"></td>
        </tr>
        <tr>
