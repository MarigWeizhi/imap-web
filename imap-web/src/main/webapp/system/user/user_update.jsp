...
<%--                    <input type="hidden" name="fileId" id="fileId_image" value="<c:out value="${filePd.id}" />" class="layui-input">--%>
<%--                    <input type="hidden" name="filePath" id="filePath_image" value="<c:out value="${filePd.file_path}" />" class="layui-input">--%>
<%--                    <button type="button" class="layui-btn layui-btn-xs" id="upload_image">选择封面</button>--%>
<%--                    <div class="layui-upload-list">--%>
<%--                        <c:if test="${filePd.file_path==''||filePd.file_path==null}">--%>
<%--                            <img class="layui-upload-img" style="width: 160px" id="file_image" src="">--%>
<%--                        </c:if>--%>
<%--                        <c:if test="${filePd.file_path!=''&&filePd.file_path!=null}">--%>
<%--                            <img class="layui-upload-img" style="width: 160px" id="file_image" src="<c:out value="${pd.file_prefix}" /><c:out value="${filePd.file_path}" />">--%>
<%--                        </c:if>--%>
<%--                        <p id="tip_image"></p>--%>
<%--                    </div>--%>
<%--                </div>--%>
