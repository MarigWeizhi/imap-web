/**
 * Created by qingfeng on 2019-6-10.
 */
var form_verify = {
    pass: [/(.+){6,12}$/, '密码必须6到12位'],
    ...
    longitude:[/^-?(((\d|[1-9]\d|1[0-7]\d|0)\.\d{0,14})|(\d|[1-9]\d|1[0-7]\d|0{1,3})|180\.0{0,10}|180)$/i,'请输入正确的经度'],
    latitude:[/^-?([0-8]?\d{1}\.\d{0,14}|90\.0{0,10}|[0-8]?\d{1}|90)$/i,'请输入正确的纬度'],
