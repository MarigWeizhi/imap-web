/**
 * Created by qingfeng on 2019-4-28.
 */
(function($, window, document, undefined) {
    ...
    BootstrapDualListbox.prototype = {
        init: function() {
            if(this.selectButtonClick){
                this.container = $("" + '<div class="bootstrap-duallistbox-container">' + ' <div class="box1">' + "   <label></label>" +
                    /**'   <span class="info-container">'+'     <span class="info"></span>'+'     <button type="button" class="btn clear1 pull-right"></button>'+"   </span>"+**/
                    '   <input class="filter form-control ue-form" type="text">' + '   <select lay-ignore multiple="multiple"></select>' + " </div>" + ' <div class="btn-box">' + '     <button type="button" class="btn db-btn move">' + "       <i></i>" + "     </button>" + '     <button type="button" class="btn db-btn moveall">' + "       <i></i>" + "       <i></i>" + "     </button>" + '     <p class="clearfix" style="margin-bottom:20px"></p>' + '     <button type="button" class="btn db-btn remove">' + "       <i></i>" + "     </button>" + '     <button type="button" class="btn db-btn removeall">' + "       <i></i>" + "       <i></i>" + "     </button>" + " </div>" + ' <div class="box2">' + "   <label></label>" +
                    /**'   <span class="info-container">'+'     <span class="info"></span>'+'     <button type="button" class="btn clear2 pull-right"></button>'+"   </span>"+**/
                    '   <input class="filter form-control ue-form" type="text">' + '   <select lay-ignore multiple="multiple"></select>' + " </div>" +
                    /**' <div class="settingUp-btns">'+'    <button class="btn db-btn upBtn">'+"      <i></i>"+"    </button>"+'    <button class="btn db-btn downBtn">'+"      <i></i>"+"    </button>"+" </div>"+**/
                    "</div>").insertBefore(this.element);
            }else{
                this.container = $("" + '<div class="bootstrap-duallistbox-container">' + ' <div class="box1">' + "   <label></label>" +
                    /**'   <span class="info-container">'+'     <span class="info"></span>'+'     <button type="button" class="btn clear1 pull-right"></button>'+"   </span>"+**/
                    '   <input class="filter form-control ue-form" type="text">' + '   <select lay-ignore multiple="multiple"></select>' + " </div>" + ' <div class="btn-box">' + '     <button type="button" disabled class="btn db-btn move">' + "       <i></i>" + "     </button>" + '     <button type="button" disabled class="btn db-btn moveall">' + "       <i></i>" + "       <i></i>" + "     </button>" + '     <p class="clearfix" style="margin-bottom:20px"></p>' + '     <button type="button" disabled class="btn db-btn remove">' + "       <i></i>" + "     </button>" + '     <button type="button" disabled class="btn db-btn removeall">' + "       <i></i>" + "       <i></i>" + "     </button>" + " </div>" + ' <div class="box2">' + "   <label></label>" +
                    /**'   <span class="info-container">'+'     <span class="info"></span>'+'     <button type="button" class="btn clear2 pull-right"></button>'+"   </span>"+**/
                    '   <input class="filter form-control ue-form" type="text">' + '   <select lay-ignore multiple="multiple"></select>' + " </div>" +
                    /**' <div class="settingUp-btns">'+'    <button class="btn db-btn upBtn">'+"      <i></i>"+"    </button>"+'    <button class="btn db-btn downBtn">'+"      <i></i>"+"    </button>"+" </div>"+**/
                    "</div>").insertBefore(this.element);
