...
Point.prototype = {
	...
	optionsToObject: function (options) {
		...
		if (typeof options === 'number' || options === null) {
			...
			// to be considered in draqingfengLabels. These can only occur in object configs.
...
var PieSeries = {
	...
	/**
	 * Override the base draqingfengLabels method by pie specific functionality
	 */
	draqingfengLabels: function () {
		var series = this,
			data = series.data,
		...
		// run parent method
		Series.prototype.draqingfengLabels.apply(series);
	...
	verifyDataLabelOverflow: function (overflow) {
		...
		// If the size must be decreased, we need to run translate and draqingfengLabels again
		if (newSize < center[2]) {
			center[2] = newSize;
