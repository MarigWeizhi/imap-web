...
seriesTypes.arearange = Highcharts.extendClass(seriesTypes.area, {
	...
	/**
	 * Extend the basic draqingfengLabels method by running it for both lower and higher
	 * values.
	 */
	draqingfengLabels: function () {
		...
		if (dataLabelOptions.enabled || this._hasPointLabels) {
			...
			seriesProto.draqingfengLabels.apply(this, arguments); // #1209
			...
			seriesProto.draqingfengLabels.apply(this, arguments);
		}
