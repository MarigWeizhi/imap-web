package com.imap.common.util;//package com.fims.util;
//
...
//		// 防止http头注入和路径遍历
//		if(http_header_manipulation(filePath) || directory_traversal_check(filePath)||http_header_manipulation(filename) || directory_traversal_check(filename)) {
//			throw new RuntimeException("文件名非法");
//		}
//
//		if(filePath.startsWith(ParaUtil.localName)||filePath.contains("KepuLicense")||filePath.contains("excelExport") || filePath.contains("ExcelExport") || filePath.contains("excelImport")){
...
////					os.write(getFormatedString(bb), 0, i);
//					os.write(bb, 0, i);
//				}
//				os.close();
//				os.flush();
...
//			}
//		} else {
//			System.out.println(filePath +"下载路径不合法!");
//		}
//	}
//
...
//		// 防止http头注入和路径遍历
//		if(http_header_manipulation(path) || directory_traversal_check(path)) {
//			throw new RuntimeException("文件名非法");
//		}
